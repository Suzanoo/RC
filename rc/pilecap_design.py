...
from tools.plot_shape import rectangleShape, addShape, add_Hline, add_Vline
...
-run script
    ...
    ex.2-piles
    python rc/pilecap_design.py --W=0.4 --H=0.4 --B=2 --L=0.8 --t=0.6 --Pu=1044 --Mux=25 --Muy=37

    ex.4-piles
    python rc/pilecap_design.py --W=0.4 --H=0.6 --B=2.1 --L=1.5 --t=0.75 --Pu=2300 --Mux=60 --Muy=90
