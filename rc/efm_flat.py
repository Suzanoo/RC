...
def factor():
    ...
    for i in range(0, len(span)):
        ...
        ksb, cof, fem = sb.flat(c1A, c1B, FLAGS.l2, FLAGS.t, l1, FLAGS.fc1)
        Ksb.append(ksb)
        COF.append(cof)
        FEM.append(fem)
    ...
    for i in range(0, len(span) + 1):
        ...
        Kc = cs.kc(FLAGS.t, FLAGS.lc, Ic, FLAGS.fc2)
...
-Run app  
    % python rc/efm_flat.py --t=190 --l2=4500 --lc=2750 
"""